...
void cx::Timer::EndTimerAndPrint(std::string eventName)
{
    ...
    auto diff = std::chrono::duration_cast<std::chrono::nanoseconds>(endTime - eventMap[eventName]);
    std::cout << std::endl
              << "#### " << eventName << " : " << diff.count() * 1.0 / 1e9 << " seconds ####" << std::endl;
    std::cout << "#### " << eventName << " : " << diff.count() << " nanoseconds ####" << std::endl
              << std::endl;
}
...
{
    std::cout << std::endl
              << "#### " << eventName << " : " << durationMap[eventName] * 1.0 / 1e9 << " seconds ####" << std::endl;
    std::cout << "#### " << eventName << " : " << durationMap[eventName] << " nanoseconds ####" << std::endl
              << std::endl;
}
